 ...
 *     time   : 2018/3/27 下午2:43
 *     desc   :动态文本
 *     version: 1.0
 * </pre>
 */
public class BabushkaText extends android.support.v7.widget.AppCompatTextView {
    /**
     * <pre>
     *     desc   :  ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ :   desc
     *     desc   :                                                                           :   desc
     ...
     */
//storeTv.reset();
//        storeTv.addPiece(new BabushkaText.Piece.Builder(ResUtil.getString(R.string.main_store_car_1))
//            .textColor(Color.parseColor("#333333"))
//            .textSize(DensityUtil.dpToSp(14))
//            .build());
//        storeTv.addPiece(new BabushkaText.Piece.Builder("¥")
//                .textColor(Color.parseColor("#333333"))
//            .textSize(DensityUtil.dpToSp(14))
//            .build());
//
//        storeTv.addPiece(new BabushkaText.Piece.Builder(PriceUtils.formatPrice(adapter.getCheckedMoney()) + "")
//                .textColor(Color.parseColor("#333333"))
//            .textSize(DensityUtil.dpToSp(14))
//            .build());
//
