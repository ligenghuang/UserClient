package com.lgh.huanglib.util.fastscrooll;
 ...
 */
abstract public class FastScrollLinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    public FastScrollLinearSmoothScroller(Context context) {
        MILLISECONDS_PER_PX = calculateSpeedPerPixel(context.getResources()
                .getDisplayMetrics());
    }
