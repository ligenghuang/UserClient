...
public class CusBgToast {
    ...
    public static void normal(@NonNull String message) {
        normal(MyApplication.getInstance(), message, Toast.LENGTH_SHORT, null, false).show();
    }

    public static void normal(@NonNull String message, Drawable icon) {
        normal(MyApplication.getInstance(), message, Toast.LENGTH_SHORT, icon, true).show();
    }

    public static void normal(@NonNull String message, int duration) {
        normal(MyApplication.getInstance(), message, duration, null, false).show();
    }

    public static void normal(@NonNull String message, int duration, Drawable icon) {
        normal(MyApplication.getInstance(), message, duration, icon, true).show();
    }

    public static Toast normal(@NonNull String message, int duration, Drawable icon, boolean withIcon) {
        return custom(MyApplication.getInstance(), message, icon, DEFAULT_TEXT_COLOR, duration, withIcon);
    }

    public static void warning(@NonNull String message) {
        warning(MyApplication.getInstance(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void warning(@NonNull String message, int duration) {
        warning(MyApplication.getInstance(), message, duration, true).show();
    }

    public static Toast warning(@NonNull String message, int duration, boolean withIcon) {
        return custom(MyApplication.getInstance(), message, getDrawable(MyApplication.getInstance(), R.drawable.ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true);
    }

    public static void info(@NonNull String message) {
        info(MyApplication.getInstance(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void info(@NonNull String message, int duration) {
        info(MyApplication.getInstance(), message, duration, true).show();
    }

    public static Toast info(@NonNull String message, int duration, boolean withIcon) {
        return custom(MyApplication.getInstance(), message, getDrawable(MyApplication.getInstance(), R.drawable.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true);
    }

    public static void success(@NonNull String message) {
        success(MyApplication.getInstance(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void success(@NonNull String message, int duration) {
        success(MyApplication.getInstance(), message, duration, true).show();
    }

    public static Toast success(@NonNull String message, int duration, boolean withIcon) {
        return custom(MyApplication.getInstance(), message, getDrawable(MyApplication.getInstance(), R.drawable.ic_check_white_48dp), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true);
    }

    public static void error(@NonNull String message) {
        error(MyApplication.getInstance(), message, Toast.LENGTH_SHORT, true).show();
    }
    ...
    public static void error(@NonNull String message, int duration) {
        error(MyApplication.getInstance(), message, duration, true).show();
    }

    public static Toast error(@NonNull String message, int duration, boolean withIcon) {
        return custom(MyApplication.getInstance(), message, getDrawable(MyApplication.getInstance(), R.drawable.ic_clear_white_48dp), DEFAULT_TEXT_COLOR, ERROR_COLOR, duration, withIcon, true);
    }
    ...
    public static void showToastShort(int resId) {
        Toast.makeText(MyApplication.getInstance(), MyApplication.getInstance().getString(resId), Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showToastLong(int resId) {
        Toast.makeText(MyApplication.getInstance(), MyApplication.getInstance().getString(resId), Toast.LENGTH_LONG).show();
    }
    ...
    public static void showToast(int resId) {
        if (mToast == null) {
            mToast = Toast.makeText(MyApplication.getInstance(), MyApplication.getInstance().getString(resId), Toast.LENGTH_LONG);
        } else {
            mToast.setText(MyApplication.getInstance().getString(resId));
        }
        mToast.show();
    }
