...
* date : 2019/6/18
*/
public class DepartFindDoctorAction extends BaseAction<DepartFindDoctorView> {
    public DepartFindDoctorAction(RxAppCompatActivity _rxAppCompatActivity, DepartFindDoctorView view) {
