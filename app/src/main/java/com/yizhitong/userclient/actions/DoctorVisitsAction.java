 ...
 * date : 2019/6/19
 */
public class DoctorVisitsAction extends BaseAction<DoctorVisitsView> {
    public DoctorVisitsAction(RxAppCompatActivity _rxAppCompatActivity, DoctorVisitsView view) {
     ...
     * 获取快速问诊费用
     */
    public void getRegisteredAmount(String iuid){
        post(WebUrlUtil.POST_DOCTOR_AMOUNT, false, service -> manager.runHttp(
                service.PostData_1(CollectionsUtils.generateMap("docIuid",iuid), WebUrlUtil.POST_DOCTOR_AMOUNT)));
    }
    ...
    public void addAskHead(List<String> imgs, AddAskHeadPost post){
        ...
        RequestBody requestBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
                ...
                .addFormDataPart("mycars",post.toString2())
                .build();
