...
public class MediaFileUtil {
    ...
    static {
        ...
        addFileType("MP4", FILE_TYPE_MP4, "profit_video/mp4");
        addFileType("M4V", FILE_TYPE_M4V, "profit_video/mp4");
        addFileType("3GP", FILE_TYPE_3GPP, "profit_video/3gpp");
        addFileType("3GPP", FILE_TYPE_3GPP, "profit_video/3gpp");
        addFileType("3G2", FILE_TYPE_3GPP2, "profit_video/3gpp2");
        addFileType("3GPP2", FILE_TYPE_3GPP2, "profit_video/3gpp2");
        addFileType("WMV", FILE_TYPE_WMV, "profit_video/x-ms-wmv");
    ...
    public static boolean isImageFileType(String path) {
        MediaFileType type = getFileType(path);
        if(null != type) {
            L.e("xx","MediaFileType "+type.fileType+"   "+type.mimeType);
