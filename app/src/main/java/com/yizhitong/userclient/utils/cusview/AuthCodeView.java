...
//        mPaint.reset();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setColor(ResUtil.getColor(R.color.color_c));
    ...
    //刷新验证码
    public void refresh(String authCode){
        code = authCode;
        invalidate();//重新ondraw
    }
